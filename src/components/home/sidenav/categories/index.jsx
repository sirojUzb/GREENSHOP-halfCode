...
const Categories = () => {
  ...
  const normal_text =
    "w-full flex items-center justify-between mt-[7px] hover:text-[#46a358] cursor-pointer";
  const active_text =
    "w-full flex items-center justify-between mt-[7px] text-[#46a358] cursor-pointer";
